...
const Navigation = () => {
  ...
  return (
    <>
      <div className="flex lg:hidden w-full bg-citrus-yellow h-12 items-center fixed z-20">
        <div
      ...
      >
        <div className="bg-citrus-yellow h-full flex flex-col justify-between items-center w-full">
          <div className="hidden lg:flex items-center my-3">
            <Image src={LOGO} className=" mx-2" alt={`${CONFIG.name} Logo`} />
          </div>
