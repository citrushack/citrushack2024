...
const Form = ({
  ...
  return (
    <div className="w-full h-full overflow-scroll-y flex flex-col items-center font-raleway">
      ...
      <div className="w-10/12 md:w-1/2 xl:w-1/3 my-5 flex flex-col items-center justify-center">
        <Image src={logo} className="w-1/2" />
        <p className="mt-6 w-full text-xl bg-citrus-green-100 font-semibold px-4 py-2 rounded-t-xl m-0">
          {header}
        </p>
        <div className="rounded-b-xl bg-gray-200 p-3">
