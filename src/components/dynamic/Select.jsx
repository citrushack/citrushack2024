  ...
  return (
    <div ref={parent}>
      ...
      <button
        ...
        } bg-transparent flex items-center justify-between w-full border-b-2 border-black pb-1`}
      ...
      {show && (
        <div className="relative">
          <div
            ref={ref}
            className="absolute overflow-y-scroll bg-white w-full h-fit max-h-[35vh]"
            data-cy="select-menu"
          >
            {searchable && (
              <input
                value={input}
                autoFocus
                className="my-1 w-full ring-0 outline-none px-2 py-2 bg-white sticky top-0 left-0 z-10"
                placeholder="search"
            ...
            >
              {getVirtualItems().map((virtualRow) => {
                ...
                return (
                  <div
                    className="absolute top-0 left-0 w-full hover:bg-black hover:text-white hover:cursor-pointer flex items-center px-2"
