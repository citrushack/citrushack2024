    ...
    <div ref={parent}>
      ...
      {show && (
        <div className="relative">
          <div
            ref={ref}
            className="absolute overflow-y-scroll bg-citrus-gray-100 w-full h-fit max-h-[35vh]"
            data-cy="select-menu"
          >
            {searchable && (
              <input
                value={input}
                autoFocus
                className="my-1 w-full ring-0 outline-none px-2 py-2 bg-citrus-gray-100 sticky top-0 left-0 z-10"
                placeholder="search"
            ...
            >
              {getVirtualItems().map((virtualRow) => {
                ...
                return (
                  <div
                    className="absolute top-0 left-0 w-full hover:bg-citrus-green-100 hover:cursor-pointer flex items-center px-2"
