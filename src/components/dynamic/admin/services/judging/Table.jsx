      ...
      {data
        ...
        .map(({ name, links, table, rounds }, index) => (
          <div key={index} className="flex justify-between items-start p-2">
            <div className="bg-citrus-beige-100 w-full p-3 rounded-xl">
              <div className="flex justify-between items-center">
                    ...
                    links
                      ...
                      .map((link, index) => (
                        <Link
                          ...
                          href={link.link}
                          target="_blank"
                          className="m-0 p-0 text-black no-underline hover:!text-citrus-green-100 text-xl"
                        >
                          {ICONS[link.name]}
                        </Link>
                      ))}
                ...
                {table && (
                  <p className="mb-0 text-citrus-green-100 font-semibold whitespace-nowrap">
                    table {table}
                  </p>
                )}
              </div>
